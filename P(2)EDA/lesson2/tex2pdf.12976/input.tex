...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mtcars[mtcars}\OperatorTok{$}\NormalTok{qsec }\OperatorTok{<=}\FloatTok{16.90}\NormalTok{, ]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mtcars}\OperatorTok{$}\NormalTok{year <-}\StringTok{ }\DecValTok{1974}
\end{Highlighting}
\end{Shaded}
